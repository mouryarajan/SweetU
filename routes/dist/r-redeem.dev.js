...
var redeem = require('../controllers/c-redeem.js');
...
router.post('/api/get-redeemlog-user', redeem.postGetRedeemLogUser); //uncomment bellow code to insert data from post man
